...
# กำหนดชื่อตัวแปรสำหรับพารามิเตอร์ใหม่
CONF_CS_PIN = 'cs_pin'
...
CONFIG_SCHEMA = text_sensor.text_sensor_schema(LoRaComponent).extend({
    ...
    cv.Optional(CONF_SYNC_WORD, default=0x12): cv.hex_int,
    cv.Optional(CONF_BANDWIDTH, default=125e3): cv.float_,
